                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p><small style="color: red">※一度削除した動画本は再度追加することができます</small>
                                    </p>
                                    <form method="post" class="delete" action="{{ route('likes.destroy', $post->id) }}">
                                        @csrf
                                        @method('delete')
        ...
        <div class="vizew-pager-prev">
            ...
            <div class="single-feature-post video-post bg-img pager-article"
                ...
                <div class="post-content">
                    ...
                    <a href="single-post.html" class="post-title">Searching for the 'angel' who held me on Westminster
                        Bridge</a>
        ...
        <div class="vizew-pager-next">
            ...
            <div class="single-feature-post video-post bg-img pager-article"
                ...
                <div class="post-content">
                    ...
                    <a href="single-post.html" class="post-title">Reunification of migrant toddlers, parents should be
                    ...
                    <div class="post-details-content d-flex">
                        ...
                        <div class="blog-content">
                            ...
                            <p>I love dals. All kinds of them but yellow moong dal is my go-to lentil when I am in need of
                                ...
                                feathery leaves of dill are also rich in Vitamin A, C and minerals like iron and manganese.
                            </p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="single-post-area mb-50">
                                            ...
                                            <div class="post-content">
                                                <a href="#" class="post-cata cata-sm cata-success">Sports</a>
                                                <a href="single-post.html" class="post-title">Warner Bros. Developing ‘The
                                                    accountant’ Sequel</a>
                                                <div class="post-meta d-flex">
