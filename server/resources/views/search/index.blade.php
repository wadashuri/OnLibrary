                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($categories as $value)
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="category[]" id="category{{ $value->id }}" value="{{ $value->id }}"
                                                {{ in_array(strval($value->id), $category) ? 'checked' : '[]' }}>
                                            <label class="custom-control-label"
                                                for="category{{ $value->id }}">{{ $value->category }}</label>
                                        </div>
                                    @endforeach
                                </div>
                                <div class="form-group">
                                    ...
                                    @foreach ($book_tuber_categories as $value)
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="book_tuber_category[]" id="checkbox{{ $value->id }}" value="{{ $value->id }}"
                                                {{ in_array(strval($value->id), $book_tuber_category) ? 'checked' : '[]' }}>
                                            <label class="custom-control-label"
                                                for="checkbox{{ $value->id }}">{{ $value->book_tuber_category }}</label>
                                        </div>
                                    @endforeach
                                </div>
